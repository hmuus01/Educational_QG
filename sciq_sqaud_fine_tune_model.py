...
sciq_squad_train_df = pd.read_csv('data/squad_sciq/sciq_squad_t.csv')
sciq_squad_test_df = pd.read_csv('data/squad_sciq/sciq_squad_test.csv')
print(sciq_squad_train_df.shape)

sciq_squad_train_df.head()

sciq_squad_dev_df = pd.read_csv('data/squad_sciq/sciq_squad_valid.csv')
print(sciq_squad_dev_df.shape)

sciq_squad_dev_df.head()
...
test_df = sciq_squad_test_df
train_df = sciq_squad_train_df

## Dev set
dev_df = sciq_squad_dev_df
...
checkpoint_callback = ModelCheckpoint(
    dirpath='checkpoints',
    filename='science_sci_squad-test-best-checkpoint',
    save_top_k=-1,
    verbose=True,
    monitor='val_loss',
    mode='min'
